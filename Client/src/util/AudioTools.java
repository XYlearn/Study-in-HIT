 ...
 /*public static void main(String[] args)
	...
	public static String stopAndSaveCapture()
	{
		synchronized (status)
		{
			...
			File audioFile=new File(test.AUDIOPATH+"tmpCapture.wav");
			try
			{
			...
			audioFile.renameTo(new File(test.AUDIOPATH+filename));
			if (audioFile.exists())
				audioFile.delete();
			return filename;
		}
	...
	public static boolean isCapturing()
	{
		synchronized (status)
		{
			return status==Status.CAPTURING;
		}
	}
